...
class SearchTool:
    ...
    def _setup_tools(self) -> List:
        ...
        def search_attractions(place:str) -> str:
            ...
            logger.info(f"Searching attractions for place: {place}")
            try:
        ...
        def search_restaurants(place:str) -> str:
            ...
            logger.info(f"Searching restaurants for place: {place}")
            try:
        ...
        def search_activities(place:str) -> str:
            ...
            logger.info(f"Searching activities for place: {place}")
            try:
        ...
        def search_transportation(place:str) -> str:
            ...
            logger.info(f"Searching transportation for place: {place}")
            try:
